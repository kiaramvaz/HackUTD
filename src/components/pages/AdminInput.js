...
export default function AdminInput() {
    ...
    return (
        ...
        <div className = 'Background' >
            ...
            <h2 align = 'center'> ADD A CLUB </h2>
            <Grid align = "center" style = {cardStyle}>

            <TextField id="outlined-basic" label="Club Name" variant="outlined" style={txstyle} fullWidth />
            </Grid>

            <Grid align = "center">
            <TextField id="outlined-basic" label="Club Leadership" variant="outlined" />
            <TextField id="outlined-basic" label="Club Sponsor" variant="outlined" />
            <TextField id="outlined-basic" label="Club Requirements" variant="outlined" />
